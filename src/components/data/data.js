...
const experienceData = [
  {
    ...
    dateEnded: null,
    companyLink: "https://www.boozallen.com/",
    skillsUsed: [
  ...
  },
  {
    ...
    jobSite: "https://www.boozallen.com/",
    location: "Alexandria, VA",
    dateStarted: "Jan 2019​ ",
    dateEnded: null,
    companyLink: "https://www.boozallen.com/",
  ...
  },
  {
    ...
    dateEnded: "Jan 2019",
    companyLink: "https://www.metistream.com/",
    skillsUsed: [
...
const designBlogData = [
  {
    blogTitle: "Happy Tail VA LLC",
    blogStartDate: "",
    blogEndData: "",
    challengeOutline: "To help Happy Tail VA expand their current platform to an online presence where users can learn more about their services, values, and mission.",
    companyDescription: "Happy Tail VA (Now an LLC) is a dog walking/boarding startup founded and managed by animal enthusiast Fiorella Gambini. Alongside dog walking, the company also focuses on training, vaccinations, and informing customers of better pet care.",
    companySiteGoals: ["Inform users of what the business is and services it provides", "Provide point of contact between clients and business", "Allow access to informational postings about pet and animal care"],
    platForm: ["Desktop", "Tablet", "Mobile"],
    designChallenges: "",
    designSolutions: "",
    users: {
      primaryAudience: ["Med - High Value Customers"],
      secondaryAudience: ["Low value Customers", "Potential Customers",
      "Ex-Customers"]
    },
    keyAudience: {
      dataAquisition: ["Facebook Survey"],
      highValue: ["30-50 years Family-oriented Local area", "Own a single pet", "Full time work"],
      medValue: ["20-30 years", "Single or Family w/ no kids", "Local area"],
      lowValue: ["20-30 years", "Single or Family w/ no kids", "Own 2 or more animals Differing work schedule"],
      potentialCustomers: ["30-50 years", "Family-oriented"],
      potentialEmployees: ["18 - late 20s", "Single", "College Student", "A bit further away from business"],
      exCustomers: []
    },
    personas: {
      title: "Building Personas of Low Value Audience to Convert to Medium - High Value Audience",
      wants: ["To easily schedule a dog walking appointment", "To be able to quickly contact the walker/boarder", "To be able see all the services available by the company"],
      painPoint: ["Time consuming to have to look up business site information", "Time consuming to understand differing price rates", "Users weren't able see all the services available by the company on Facebook"],
      motivation: ["Saving time", "Maintaining pet health", "Convenience"],
      needs: ["How much does it cost to walk my dog?", "Where are you located?", "Do you offer any additional services? local office / contact details", "What kind of certifications do you have?"],
      solutions: ["Accessibility", "Responsive website design", "Video - display business in action", "Contact details", "Services search/filter"],
    },
    technologiesUsed: [],
    wireframesLink: "https://xd.adobe.com/view/7ace75af-c65d-4b81-59e0-fd8565a4b4fa-0cff/?fullscreen",
    githubLink: ""
  },
  {
    blogTitle: "Happy Tail VA LLC",
